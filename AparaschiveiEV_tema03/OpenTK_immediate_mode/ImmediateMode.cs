...
namespace OpenTK_immediate_mode
{
    class ImmediateMode : GameWindow
    {
        ...
        private void DrawAxes() {
            ...
            // Definirea unui triunghi și mai mare cu culori diferite la fiecare vârf
            GL.Color3(Color.Red);       // Vârful 1 - roșu
            GL.Vertex3(-2.0f, -2.0f, 0);

            GL.Color3(Color.Green);     // Vârful 2 - verde
            GL.Vertex3(2.0f, -2.0f, 0);

            GL.Color3(Color.Blue);      // Vârful 3 - albastru
            GL.Vertex3(0.0f, 2.0f, 0);
